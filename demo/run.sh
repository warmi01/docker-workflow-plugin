...
# quaha01: File copied from Jenkins image /usr/local/bin/run.sh to comment out start of
# jetty since the an embedded jetty is started with Jenkins.  This file will overwrite that file.
